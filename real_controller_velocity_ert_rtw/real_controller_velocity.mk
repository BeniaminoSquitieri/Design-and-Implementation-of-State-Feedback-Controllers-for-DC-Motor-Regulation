###########################################################################
## Makefile generated for component 'real_controller_velocity'. 
## 
## Makefile     : real_controller_velocity.mk
## Generated on : Tue May 28 23:27:26 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/real_controller_velocity.elf
...
PRODUCT_NAME              = real_controller_velocity
MAKEFILE                  = real_controller_velocity.mk
...
COMPILER_COMMAND_FILE     = real_controller_velocity_comp.rsp
CMD_FILE                  = real_controller_velocity.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/real_controller_velocity.elf
...
DEFINES_STANDARD = -DMODEL=real_controller_velocity -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o MW_PWM.o soc_stm_encoder.o xcp_ext_mode.o real_controller_velocity.o real_controller_velocity_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o mw_mbed_interface.o BufferedSerial.o blapp_support.o mbed_syscalls.o SysTickScheduler.o m3m4m4f_multitasking.o sys_arch.o xcp_platform_timer_mbed.o rtiostream_serial_mbed.o
...
LDFLAGS_ = @C:\EMBEDD~1\Progetto\REAL_C~2\MBED_O~1.RSP
...
SHAREDLIB_LDFLAGS_ = @C:\EMBEDD~1\Progetto\REAL_C~2\MBED_O~1.RSP
...
CPP_LDFLAGS_ = @C:\EMBEDD~1\Progetto\REAL_C~2\MBED_O~1.RSP
...
CPP_SHAREDLIB_LDFLAGS_ = @C:\EMBEDD~1\Progetto\REAL_C~2\MBED_O~1.RSP
...
%.o : $(START_DIR)/real_controller_velocity_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/real_controller_velocity_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/real_controller_velocity_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/real_controller_velocity_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/real_controller_velocity_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/real_controller_velocity_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


real_controller_velocity.o : $(START_DIR)/real_controller_velocity_ert_rtw/real_controller_velocity.c
	$(CC) $(CFLAGS) -o "$@" "$<"


real_controller_velocity_data.o : $(START_DIR)/real_controller_velocity_ert_rtw/real_controller_velocity_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/real_controller_velocity_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/real_controller_velocity_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/real_controller_velocity_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
